...
*   [Searching and Sorting CSES](https://cses.fi/problemset/) [ pick only searching problems ]
...
*   We already would have covered this in math section, but if it is pending
