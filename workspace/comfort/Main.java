...
public class Main {
    ...
    //init methods for static varaibles


    //helper methods to help in solution
    ...
    private void solve(Printer out, int testcase) throws Exception {
        ...
        int [] x = scanner.nextIntArray(n);
        int [] y = scanner.nextIntArray(n);
        int [][] arr=new int[n][];
        for(int i=0;i<n;i++){
